...
const NameParamMap name_param_map[] = {
    ...
    {PARAM_ROTATE_SPD, &spacelight_param.rotate_spd, "SPD"},
    ...
    {PARAM_INDEP_DIM1, &spacelight_param.indep_dim[0], "DIM"},
    {PARAM_INDEP_DIM2, &spacelight_param.indep_dim[1], "DIM"},
    {PARAM_INDEP_DIM3, &spacelight_param.indep_dim[2], "DIM"},
    {PARAM_INDEP_DIM4, &spacelight_param.indep_dim[3], "DIM"},
    {PARAM_INDEP_CCT1, &spacelight_param.indep_cct[0], "CCT"},
    {PARAM_INDEP_CCT2, &spacelight_param.indep_cct[1], "CCT"},
    {PARAM_INDEP_CCT3, &spacelight_param.indep_cct[2], "CCT"},
    {PARAM_INDEP_CCT4, &spacelight_param.indep_cct[3], "CCT"},
